...
interface WaitlistIsotypeProps {
  className?: string
}

function WaitlistIsotype({ className }: WaitlistIsotypeProps) {
  return (
    <svg
      className={cn('size-[22px] shrink-0 sm:size-6', className)}
      viewBox="0 0 24 23"
      overflow="visible"
      aria-hidden
    >
