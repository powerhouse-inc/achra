...
const tableVariants = cva('relative w-full', {
  variants: {
    variant: {
      ...
      pills:
        'overflow-x-visible [&_table]:text-sm/5.5 xl:[&_table]:text-base/6 [&_table]:border-separate [&_table]:border-spacing-y-2 [&_tr]:rounded-xl [&_tr_th]:py-4 [&_tr_th:first-child]:pl-2 [&_tr_th:last-child]:pr-2 xl:[&_tr_th:first-child]:pl-3 xl:[&_tr_th:last-child]:pr-3 2xl:[&_tr_th:first-child]:pl-3.5 2xl:[&_tr_th:last-child]:pr-3.5 [&_tbody_tr_td]:py-3 [&_tr_td:first-child]:pl-4 [&_tr_td:last-child]:pr-4 [&_thead_tr]:outline [&_thead_tr]:outline-border [&_thead_tr_th]:text-foreground/50 [&_thead]:bg-color-background [&_tr]:shadow-xs',
    },
  },
  defaultVariants: {
    variant: 'default',
