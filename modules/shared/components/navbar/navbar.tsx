...
function Navbar() {
  ...
  return (
    <header className="bg-muted/30 shadow-modules sticky top-0 z-50 container mx-auto flex items-center justify-center rounded-3xl backdrop-blur-[7.5px] md:p-1.5">
