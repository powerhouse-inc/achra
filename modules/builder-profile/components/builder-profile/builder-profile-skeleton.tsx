...
function ConnectButtonSkeleton({ className }: ActionsSkeletonProps) {
  return (
    <div className={cn('bg-accent flex w-56.25 flex-col gap-6 rounded-md', className)}>
      <div className="flex justify-end">
        <div className="flex items-center gap-4 py-1.5 pr-2 pl-4">
  ...
  return (
    <div className="border-border bg-popover flex w-full flex-col gap-4 rounded-xl border p-3 shadow-sm">
      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:justify-between">
        <div className="border-border bg-popover flex w-full flex-col gap-2 rounded-lg border px-4 py-2 sm:w-104.5">
