...
export async function fetchPowerhouseScopeOfWork(): Promise<ScopeOfWorkQuery | undefined> {
  return switchboardFetcher(ScopeOfWorkDocument, {
    docId: SCOPE_OF_WORK_DOCUMENT_ID,
  })() as Promise<ScopeOfWorkQuery | undefined>
}

export function getRoadmapFromScopeOfWork(
  scopeOfWork: ScopeOfWorkQuery | undefined,
  roadmapSlug: string,
