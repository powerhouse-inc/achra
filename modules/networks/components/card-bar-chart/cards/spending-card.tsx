...
export function SpendingCard() {
  return (
    ...
    >
      <span className="text-muted-foreground sm:text-popover-foreground sm:bg-popover mb-2 w-full justify-center text-center text-xs/5 font-medium sm:absolute sm:-top-2 sm:left-6 sm:mb-0 sm:w-fit sm:rounded-lg sm:px-2 sm:py-0 md:text-sm md:leading-5 md:font-semibold xl:text-base xl:leading-5">
        Spending
      </span>
