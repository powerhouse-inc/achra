...
function ForumPostSkeleton() {
  return (
    <div className="bg-muted/30 border-border flex flex-col gap-2 rounded-xl border shadow-sm md:flex-row md:gap-0 md:shadow-none">
      <div className="border-border flex w-full min-w-0 flex-col justify-center gap-2 rounded-xl p-2 md:min-w-85 md:p-2 lg:min-w-127 lg:p-2 xl:min-w-175 xl:p-4 2xl:min-w-201">
