...
const mockConfiguration: ConfigurationData = {
...
function Summary({ selectedPlan, enabledSections, onBack }: Readonly<SummaryProps>) {
  const [legalEntity, setLegalEntity] = useState(mockConfiguration.legalEntity)
  const [teamStructure, setTeamStructure] = useState(mockConfiguration.teamStructure)
  const [anonymityLevel, setAnonymityLevel] = useState(mockConfiguration.anonymityLevel)
