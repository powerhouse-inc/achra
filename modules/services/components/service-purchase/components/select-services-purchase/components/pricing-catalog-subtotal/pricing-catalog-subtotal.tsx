...
export default function PricingCatalogSubtotal({
  ...
  return (
    <div className="border-input border-t border-b pl-6">
      <div className="grid grid-cols-[minmax(0,4fr)_repeat(4,minmax(0,1fr))] items-center gap-4">
        <span className="text-foreground/50 flex h-14 items-center text-base/6 font-semibold uppercase">
          {subtotal.label}
        </span>
