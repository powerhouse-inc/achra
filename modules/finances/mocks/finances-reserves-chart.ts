...
const MONTHLY_PROTOCOL_OUTFLOW: Record<(typeof BUDGET_PATHS)[number], number[]> = {
  'atlas/legacy': [
    68000, 71000, 69500, 70200, 71500, 72500, 73100, 72000, 70500, 69800, 69000, 71200,
  ],
  'atlas/scopes': [
    109000, 111500, 113000, 115000, 116500, 118000, 119500, 117500, 116000, 114500, 113500, 115000,
  ],
  'atlas/immutable': [
    83000, 84500, 85200, 86000, 87200, 88500, 89300, 88800, 87700, 86800, 85900, 87000,
  ],
}
