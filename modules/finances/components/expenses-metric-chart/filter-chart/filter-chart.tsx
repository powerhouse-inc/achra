...
import { granularityParser, metricParser } from '../../../lib/expenses-metric-chart-search-params'
...
import { ExpensesMetricSelectDrawer } from '../filter-metric-expenses-metric-chart/filter-metric-expenses-metric-chart'
    ...
    <div className="row flex gap-4">
      ...
      <div className="flex items-center gap-4 md:hidden">
        <FilterDrawer onReset={onReset}>
          <ExpensesMetricSelectDrawer metric={metric} setMetric={setMetric} />
