...
import LegendItemBreakDownChart from './breakdown-chart-item'
import SwitchComponent from './breakdown-chart-switch'
...
export default function LegendBreakDownChart({
  series,
  handleToggleSeries,
  onLegendItemHover,
  onLegendItemLeave,
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {series.map((element) => {
                  const value = element.data.reduce(
